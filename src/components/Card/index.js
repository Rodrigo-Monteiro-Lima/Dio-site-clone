    ...
    <CardContainer>
      ...
      <Content>
        <UserInfo>
          ...
          <div>
            <h4>Rodrigo Monteiro</h4>
            <p>Há 8 minutos</p>
          </div> 
        </UserInfo>
        <PostInfo>
          <h4>Projeto para curso de React </h4>
          <p>Projeto feito no curso de formação React Developer da dio...<strong>Saiba Mais</strong></p>
        </PostInfo>
        <HasInfo>
